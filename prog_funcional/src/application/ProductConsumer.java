...
public class ProductConsumer {
	...
	public static void productConsumer3() {
		...
		//Argumento do "forEach" recebe um Objeto do tipo Consumer; (Objeto do tipo Consumer é um objeto (classe) de uma unica função.
		//Quando eu uso um método referenciado (Reference Method) eu estou invocando um Consumer?
		//Consumer é uma implementação de uma interface de um metodo só
		//O Java provavelmente interpreta o método statico como uma implementação de uma interface funcional
